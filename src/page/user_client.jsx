...
const UserCliente = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.get(`https://mcv-backend-deploy.vercel.app/get_clientes/${numero_documento}`);
            if (response.data) {
    ...
    const actualizarCliente = async () => {
        try {
            const response = await axios.patch(`https://mcv-backend-deploy.vercel.app/get_clientes/actualizar/${numero_documento}`, {
