...
function GestionarAgenda() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const result = await axios.get('https://mcv-backend-deploy.vercel.app/agendar/especialista/VET');
      ...
      try {
        const result2 = await axios.get('https://mcv-backend-deploy.vercel.app/agendar/especialista/GRO');
