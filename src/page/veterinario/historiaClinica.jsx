...
const RegistroMascota = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (buffer) {
            ...
            try {
                const link = await axios.post('https://mcv-backend-deploy.vercel.app/files/avatarMascota', formData, {
                    headers: {
        ...
        axios.post('https://mcv-backend-deploy.vercel.app/registro-mascota/generar_1', newData)
            .then((response) => {
                Swal.fire({
                    title: "¡Buen trabajo!",
    ...
    useEffect(() => {
        axios.get('https://mcv-backend-deploy.vercel.app/registro-mascota/raza')
            .then((response) => {
        ...
        axios.get('https://mcv-backend-deploy.vercel.app/registro-mascota/genero_mascota')
            .then((response) => {
